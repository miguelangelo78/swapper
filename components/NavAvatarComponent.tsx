...
export default function NavAvatar({ user, notificationsCount, matchCount, myMatchRequestsCount }: { user: SwapperUser, notificationsCount: number, matchCount: number, myMatchRequestsCount: number }) {

...
export default function SetupFormWizardComponent({ user }: { user: SwapperUser }) {
  ...
  const [formData, setFormData] = useState({
    ...
    originProvince: user.origin?.province || '',
    destinationProvince: user.destination?.province || '',
    originSubprovince: user.origin.subprovince || '',
    ...
    disableDestinationMajor: !!!user.destination.major,
